...
const calcEndDaysCount = (totalDays: number) => {
  ...
  let secondFiveYearsCount = 0;
  let TenYearsCount = 0;
  let twentyYearsCount = 0;
  ...
  const firstFiveYearsTotal = firstFiveYearsCount * 21;
  const secondFiveYearsTotal = secondFiveYearsCount * 28;
  const TenYearsTotal = TenYearsCount * 35;
  const twentyYearsTotal = twentyYearsCount * 42;
  return Math.floor(firstFiveYearsTotal + secondFiveYearsTotal + TenYearsTotal + twentyYearsTotal);
}
            ...
            <div class="calc-list-inner">
              <div class="calc-subtotal-list">
                <div class="calc-subtotal-list-accordion">
                  ...
                  <div class="sub-list-item">
                    ...
                    <span class="sub-item-space"></span>
                    <span class="sub-item-value">{{ formData.salary < 0 ? 0 : formData.salary }} {{ $t("QAR") }}</span>
                  </div>
                  <div class="sub-list-item">
              ...
              <div class="calc-subtotal-list total-list">
                ...
                <div class="sub-list-item total">
                  ...
                  <span class="sub-item-value">{{total.dayRate ? total.dayRate : 0}} {{$t("QAR")}}</span>
                </div>

                <div class="sub-list-item total">
                  <span class="sub-item-title">{{ $t("offDaysTotal") }}</span>
                  <span class="sub-item-value">{{total.offDaysTotal}} {{$t("QAR")}}</span>
                </div>

                <div class="sub-list-item total">
                  <span class="sub-item-title">{{ $t("endDaysTotal") }}</span>
                  <span class="sub-item-value">{{total.endDaysTotal}} {{$t("QAR")}}</span>
                </div>
              </div>
